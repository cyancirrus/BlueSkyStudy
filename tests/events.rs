...
fn events() {
    ...
    assert_eq!(app.news_feed(1), vec![Tweet::new( 3, 300, 2 )]); // NewsFeed for user 1
    assert_eq!(app.news_feed(2), vec![Tweet::new(3, 300, 2 ), Tweet::new(1, 100, 0 )]); // NewsFeed for user 2
    assert_eq!(app.unfollow(2, 1), ()); // user 2 unfollows 1
    assert_eq!(app.news_feed(2), vec![Tweet::new(3, 300, 2 )]); // NewsFeed for user 2
